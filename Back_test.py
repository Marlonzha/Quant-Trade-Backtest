...
#跑了8个标的,16个策略。用了6小时20分钟。多线程并没有带来很快的回测速度。
...
symbols_pool_path = "./Symbols_and_Strategy/Symbols.json"
strategy_pool_path = "./Symbols_and_Strategy/Strategys.json"
user_path = "./Symbols_and_Strategy/账户.json"
